...
u_soln2 = readtable("DATA.csv",Range="BE3:BE2002",ReadVariableNames=false);
...
u_soln3 = readtable("DATA.csv",Range="BA3:BA2002",ReadVariableNames=false);
...
% u_soln4 = readtable("DATA.csv",Range="BA3:BA2002",ReadVariableNames=false);
...
% u_soln5 = readtable("DATA.csv",Range="BE3:BE2002",ReadVariableNames=false);
...
leg1 = legend(string1,string2,string6);

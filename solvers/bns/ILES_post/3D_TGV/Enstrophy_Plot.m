...
u_soln2 = readtable("DATA.csv",Range="Q3:Q2002",ReadVariableNames=false);
u_soln2  = table2array(u_soln2);
t_soln2  = table2array(t_soln2);

% Import BNS Solution Data
t_soln3 = readtable("DATA.csv",Range="W3:W2002",ReadVariableNames=false);
u_soln3 = readtable("DATA.csv",Range="Y3:Y2002",ReadVariableNames=false);
...
u_soln5 = readtable("DATA.csv",Range="AO3:AO2002",ReadVariableNames=false);

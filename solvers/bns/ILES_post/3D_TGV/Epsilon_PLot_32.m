...
u_soln2  = table2array(u_soln2(1:30:2000,1));
t_soln2  = table2array(t_soln2(1:30:2000,1));
...
u_soln3  = table2array(u_soln3(1:30:2000,1));
t_soln3  = table2array(t_soln3(1:30:2000,1));
...
u_soln4  = table2array(u_soln4(1:30:2000,1));
t_soln4  = table2array(t_soln4(1:30:2000,1));
...
% u_soln5  = table2array([u_soln5(1:100:500,1);u_soln5(501:30:1001,1);u_soln5(1002:100:2000,1)]);
% t_soln5  = table2array([t_soln5(1:100:500,1);t_soln5(501:30:1001,1);t_soln5(1002:100:2000,1)]);
u_soln5  = table2array(u_soln5(1:30:2000,1));
t_soln5  = table2array(t_soln5(1:30:2000,1));
...
plot(T,u_soln2,'b-','LineWidth',1.0);hold on;
plot(T,u_soln3,'c--','LineWidth',1.0);
...
leg1 = legend(string1,string2,string3,string4,string6);

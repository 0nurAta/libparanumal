...
t_soln2 = readtable("DATA.csv",Range="AE3:AE2001",ReadVariableNames=false);
u_soln2 = readtable("DATA.csv",Range="AH3:AH2001",ReadVariableNames=false);
u_soln2  = -table2array(u_soln2);
t_soln2  =  table2array(t_soln2);

% Import BNS Solution Data
t_soln3 = readtable("DATA.csv",Range="AI3:AI2001",ReadVariableNames=false);
u_soln3 = readtable("DATA.csv",Range="AL3:AL2001",ReadVariableNames=false);

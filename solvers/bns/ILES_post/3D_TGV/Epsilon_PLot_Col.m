...
t_soln2 = readtable("DATA.csv",Range="BC3:BC2002",ReadVariableNames=false);
u_soln2 = readtable("DATA.csv",Range="BF3:BF2002",ReadVariableNames=false);
u_soln2  = -table2array(u_soln2);
t_soln2  =  table2array(t_soln2);

% Import BNS Solution Data
t_soln3 = readtable("DATA.csv",Range="AY3:AY2002",ReadVariableNames=false);
u_soln3 = readtable("DATA.csv",Range="BB3:BB2002",ReadVariableNames=false);
...
% u_soln4 = readtable("DATA.csv",Range="AT3:AT2001",ReadVariableNames=false);
% u_soln4  = -table2array(u_soln4);
% t_soln4  =  table2array(t_soln4);

% % Import BNS Solution Data
% t_soln5 = readtable("DATA.csv",Range="AU3:AU2001",ReadVariableNames=false);
% u_soln5 = readtable("DATA.csv",Range="AX3:AX2001",ReadVariableNames=false);
...
% Set Legends
string1 = '$$BNS-24\times3$$';
string2 = '$$BNS-24\times4$$';
% string3 = '$$BNS-32\times5$$';
% string4 = '$$BNS-32\times6$$';
string5 = '$$Spectral-512$$';
leg1 = legend(string1,string2,string5);
